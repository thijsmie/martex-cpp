...
\begin{itemize}
    ...
    \item Styling
    \begin{itemize}
    \item \descriptor{\command{textbf}{Text}}{Render Text in \textbf{bold}.}
    \item \descriptor{\command{textit}{Text}}{Render Text in \textit{italics}.}
...
\subsubsection{Implemented commands}
\begin{itemize}
    \item \descriptor{\command{includegraphics}{path/to/image}}{Use to display an image.}
...
\end{paragraph}
\begin{itemize}
    \item \descriptor{itemize}{A list with default marker 'bullet'}
    \item \descriptor{paragraph}{A list with default marker 'numbers'}
\end{itemize}
